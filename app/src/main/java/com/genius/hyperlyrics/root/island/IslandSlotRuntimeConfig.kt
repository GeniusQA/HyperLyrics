    ...
    companion object {
        ...
        fun from(prefs: SharedPreferences): IslandSlotRuntimeConfig {
            ...
            return IslandSlotRuntimeConfig(
                ...
                translationDisplayMode = com.genius.hyperlyrics.root.utils.TranslationHelper.getTranslationDisplayMode(prefs),
                translationFallback = com.genius.hyperlyrics.root.utils.TranslationHelper.isTranslationFallback(prefs),
