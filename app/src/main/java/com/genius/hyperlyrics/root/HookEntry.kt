...
import com.genius.hyperlyrics.lyric.source.SourceManager
import com.genius.hyperlyrics.root.island.FakeIslandTransitionHooker
import com.genius.hyperlyrics.root.island.IslandAlbumCoverStyleHooker
import com.genius.hyperlyrics.root.island.IslandMusicWaveColorHooker
import com.genius.hyperlyrics.root.island.IslandProgressGlowController
import com.genius.hyperlyrics.root.island.IslandRuntimePreferenceOverrides
import com.genius.hyperlyrics.root.island.IslandModuleRestoreHooker
import com.genius.hyperlyrics.root.island.SystemUIHookRegistry
import com.genius.hyperlyrics.root.island.IslandWidthHooker
import com.genius.hyperlyrics.root.island.RealIslandHooker
...
import com.genius.hyperlyrics.root.lyricon.central.EmbeddedLyriconCentralController
import com.genius.hyperlyrics.root.lyricon.provider.LyriconProviderControlFrameBridge
import com.genius.hyperlyrics.root.salt.SaltPlayerNextTrackHooker
import com.genius.hyperlyrics.root.source.LyriconSource
import com.genius.hyperlyrics.root.source.LyricInfoSource
import com.genius.hyperlyrics.root.source.RootLyricSink
import com.genius.hyperlyrics.root.source.SuperLyricSource
import com.genius.hyperlyrics.root.aitrans.AITranslator
...
import com.genius.hyperlyrics.provider.OfficialProviderRuntime
import com.genius.hyperlyrics.provider.OfficialProviderSystemMediaRuntime
...
class HookEntry : XposedModule() {
    ...
    override fun onModuleLoaded(param: ModuleLoadedParam) {
        ...
        HookLogger.i("HookEntry", "模块加载完成，当前应用版本${com.genius.hyperlyrics.BuildConfig.VERSION_NAME}-${com.genius.hyperlyrics.BuildConfig.VERSION_CODE}")
    }
    ...
    private fun initializeSystemEnvironment(app: Application) {
        try {
            ...
            prefListener = android.content.SharedPreferences.OnSharedPreferenceChangeListener { _, key ->
                if (com.genius.hyperlyrics.BuildConfig.DEBUG && key != null) {
                ...
                if (key?.startsWith(RootConstants.KEY_HOOK_LYRICON_PROVIDER_DELAY_PREFIX) == true ||
                    ...
                    key == RootConstants.KEY_HOOK_MANUAL_LYRIC_MATCH_REQUEST
                ) {
