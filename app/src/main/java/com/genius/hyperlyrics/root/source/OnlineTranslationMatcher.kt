...
internal object OnlineTranslationMatcher {
    ...
    private fun mergeBackgroundTranslationMetadata(
        primary: com.genius.hyperlyrics.lyric.model.RichLyricLine,
        supplemental: com.genius.hyperlyrics.lyric.model.RichLyricLine
    ...
    private fun findBestPlan(
        nativeLyrics: List<com.genius.hyperlyrics.lyric.model.RichLyricLine>,
        nativeIndex: Int,
    ...
    private fun distributeTranslations(
        nativeGroup: List<com.genius.hyperlyrics.lyric.model.RichLyricLine>,
    ...
    private fun applyTranslation(
        nativeLine: com.genius.hyperlyrics.lyric.model.RichLyricLine,
        parts: TranslationParts
    ): com.genius.hyperlyrics.lyric.model.RichLyricLine {
