...
import com.genius.hyperlyrics.common.image.AlbumImageHelper
...
import com.genius.hyperlyrics.service.NotificationPresenter
import com.genius.hyperlyrics.service.scheduler.LyricScheduler
import com.genius.hyperlyrics.service.scheduler.LyricSchedulerListener
            ...
            fetchJob = scope.launch(Dispatchers.IO) {
                ...
                if (currentSongIdentifier == data.identifier) {
                    if (!rawLines.isNullOrEmpty()) {
                        ...
                        val noLyricText = context.getString(com.genius.hyperlyrics.R.string.no_lyric_data)
