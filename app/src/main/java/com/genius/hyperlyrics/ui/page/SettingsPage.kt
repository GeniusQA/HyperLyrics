...
import com.genius.hyperlyrics.utils.LOG_EXPORT_LEVEL_DEBUG
import com.genius.hyperlyrics.utils.LogExportEnvironmentCollector
...
fun SettingsPage() {
    ...
    val backupRestoreHelper = com.genius.hyperlyrics.utils.rememberBackupRestoreHelper(snackbarHostState)
                ...
                settingsSections(
                    ...
                    onExportAllLogs = {
                        ...
                        exportAllLogsLauncher.launch(
                            "hyperlyrics_all_logs_$dateTime.txt"
                        )
                    },
                )
            }
...
private fun LazyListScope.settingsSections(
    backupRestoreHelper: com.genius.hyperlyrics.utils.BackupRestoreHelper,
