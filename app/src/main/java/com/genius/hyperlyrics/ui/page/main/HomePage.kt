...
import com.genius.hyperlyrics.ui.utils.pageContentPadding
        ...
        Box(modifier = if (backdrop != null) Modifier.layerBackdrop(backdrop) else Modifier) {
            LazyColumn(
                ...
                homePageSections(
                    ...
                    onLsposedSuperIslandToggle = onLsposedSuperIslandToggle,
                    ...
                    onLockScreenLyricsConfigClick = onLockScreenLyricsConfigClick,
